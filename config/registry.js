...
const MODULES = [
  ...
  { id:"egypt-300-641",         file:"modules/egypt-300-641.json",         label:"Byzantine and Christian Egypt 300–641", sub:"The End of the Temples, the Coptic Church, and the Coming of Islam", region:"Egypt", period:"Late Antique" },
  ...
  // ── MESOPOTAMIA / IRAQ (region:"Iraq" — the Tigris–Euphrates basin, north and south).
  //   The Assyria/Babylonia divide runs as parallel folios only where they were rival
  //   states (the 1595–539 BC stretch); before and after, one basin, one folio per era.
  //   The 632–1258 Islamic centuries are carried by the caliphate-* backbone folios below;
  //   the iraq-632-945 / iraq-945-1258 folios add the Iraq-as-place view alongside them.
  ...
  // after 539 BC the basin is one folio per era again (the north/south divide ends with the Persian conquest)
  { id:"mesopotamia-539bc-331bc", file:"modules/mesopotamia-539bc-331bc.json", label:"Achaemenid Mesopotamia 539–331 BC", sub:"The Wealthiest Satrapy of Persia — the Light Hand of Cyrus, the Revolts, the Golden Age of Astronomy, and the Coming of Alexander", region:"Iraq", period:"Ancient" },
  ...
  { id:"iraq-1534-1831", file:"modules/iraq-1534-1831.json", label:"Ottoman Iraq: the Three Provinces 1534–1831", sub:"Baghdad, Basra and Mosul on the Persian Frontier — the Wars over Baghdad, the Mamluk Pashas, the Conversion of the Tribes to Shiism, and the Shrine Cities as a State Within a State", region:"Iraq", period:"Early Modern" },
  { id:"iraq-1831-1914", file:"modules/iraq-1831-1914.json", label:"Late Ottoman Iraq 1831–1914", sub:"Direct Rule, the Tanzimat and Midhat Pasha — the 1858 Land Code and the Making of the Landlord Class, the World Market by Steamer, the Marjaiyya, and the Race for the Railway and the Oil", region:"Iraq", period:"Early Modern" },
  { id:"iraq-1914-1958", file:"modules/iraq-1914-1958.json", label:"Mandate and the Hashemite Kingdom 1914–1958", sub:"The British Conquest, the 1920 Revolt, an Imported King and an Invented State — Kirkuk Oil, the Farhud and the End of Jewish Iraq, the Failed Liberal Experiment, and the 14 July Revolution", region:"Iraq", period:"Modern" },
  { id:"iraq-1958-1979", file:"modules/iraq-1958-1979.json", label:"The Iraqi Republic 1958–1979", sub:"From Qasim to Saddam — the Land Reform and the Coups, the Ba'th and the Security State, the Oil Nationalised and the Welfare Decade, the Betrayal of the Kurds at Algiers, and the Road to Total Power", region:"Iraq", period:"Modern" },
  { id:"iraq-1979-2003", file:"modules/iraq-1979-2003.json", label:"Saddam's Iraq 1979–2003", sub:"Three Wars and a Genocide — the Iran War and the Chemical Weapons, the Anfal and Halabja, Kuwait and the Gulf War, the Crushed Uprisings and the Drained Marshes, the Sanctions Decade, and the Fall", region:"Iraq", period:"Modern" },
  { id:"iraq-2003-today", file:"modules/iraq-2003-today.json", label:"Iraq after Saddam 2003–today", sub:"The Occupation and the Dissolved State, the Sectarian Civil War, ISIS and the Ruin of Mosul, the Muhasasa Order and the Iranian Ascendancy, the Tishreen Uprising, and the Unfinished Country", region:"Iraq", period:"Modern" },
